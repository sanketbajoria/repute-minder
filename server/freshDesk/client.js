...
class Freshdesk {
    ...
    hardDeleteContact(id, cb) {
		makeRequest('DELETE', this._auth, `${this.baseUrl}/api/v2/contacts/${id}/hard_delete`, null, {id: id, force: true}, cb)
    }
    ...
    createGroup(data, cb) {
		makeRequest('POST', this._auth, `${this.baseUrl}/api/v2/groups`, null, data, cb);
    }
    ...
    deleteGroup(id, cb) {
		makeRequest('DELETE', this._auth, `${this.baseUrl}/api/v2/groups/${id}`, null, null, cb)
	}
